...
public class AutowiredAnnotationBeanPostProcessor extends InstantiationAwareBeanPostProcessorAdapter
	...
	private static final Class<? extends Annotation> injectAnnotation = resolveInjectAnnotation(); 
	
	private static Class<? extends Annotation> resolveInjectAnnotation()
	{
		try
		{
			return (Class<? extends Annotation>) ClassUtils.forName("javax.inject.Inject", AutowiredAnnotationBeanPostProcessor.class.getClassLoader());
		}
	...
	public AutowiredAnnotationBeanPostProcessor() {
		...
		{
			this.autowiredAnnotationTypes.add(injectAnnotation);
